...
*/
			function loadPlayersPage(){
				...
				for(playerNum in players){
					...
					player.setAttribute("onclick", "switchPlayers" + playerNum);
					player.innerHTML = players[playerNum].name;
					choice.appendChild(player);
					tag = tag + "<a class=\"dropdown-item\" onclick=\"switchPlayers(" + playerNum + ")\">" + players[playerNum].name + "</a>";
				}
			...
			function switchPlayers(playerNum){
				...
				var numPassing = players[playerNum].pass_yards;
				var numRushing = players[playerNum].rushing_yards;
				var numReceiving = players[playerNum].receiving_yards;

				document.getElementById("avg_p_yards").innerHTML = (numPassing/games).toFixed(2);
				document.getElementById("avg_r_yards").innerHTML = (numRushing/games).toFixed(2);
				document.getElementById("avg_rec_yards").innerHTML = (numReceiving/games).toFixed(2);
			}
